...
public class GameScreen extends AbstractScreen {
    ...
    public void render(float delta) {
        ...
        //Gdx.gl.glClearColor(context.getColorManager().currentColor.r,context.getColorManager().currentColor.g,context.getColorManager().currentColor.b,context.getColorManager().currentColor.a);
